...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", dest='output_dir', type=str,
                        default='data/msvd_nasnet_feats', help='directory to store features')
    parser.add_argument("--n_frame_steps", dest='n_frame_steps', type=int, default=20,
                        help='how many frames to sampler per video')

    parser.add_argument("--video_path", dest='video_path', type=str,
                        default='data/msvd', help='path to video dataset')
    ...
    if params['model'] == 'inception_v3':
        ...
        C, H, W = 3, 331, 331
        model = pretrainedmodels.nasnetalarge(num_classes=1001, pretrained='imagenet+background')
        load_image_fn = utils.LoadTransformImage(model)
